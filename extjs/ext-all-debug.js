...
Ext.onReady(function () {
    ...
    + (Ext.isIE6 ? 'ext-ie6' : 'ext-ie7') : Ext.isGecko
        ? "ext-gecko"
...
Ext.EventObject = function () {
    ...
    Ext.EventObjectImpl.prototype = {
        ...
        getTarget: function (selector, maxDepth, returnEl) {
            ...
            return selector
                ? t.findParent(selector, maxDepth, returnEl)
                : (returnEl ? t : this.target);
        },
...
Ext.extend(Ext.tree.TreeNode, Ext.data.Node, {
    ...
    appendChild: function () {
        var node = Ext.tree.TreeNode.superclass.appendChild.apply(this,
            arguments);
...
Ext.form.Field = Ext.extend(Ext.BoxComponent, {
    ...
    markInvalid: function (msg) {
        ...
        switch (this.msgTarget) {
            ...
            case 'under' :
                if (!this.errorEl) {
                    var elp = this.el.findParent('.x-form-element', 5,
                        true);
...
Ext.form.Radio = Ext.extend(Ext.form.Checkbox, {
    ...
    getGroupValue: function () {
        ...
        var c = p.child('input[name=' + this.el.dom.name + ']:checked',
            true);
...
Ext.extend(Ext.grid.GridView, Ext.util.Observable, {
    ...
    onRowOut: function (e, t) {
        var row;
        if ((row = this.findRowIndex(t)) !== false
            && row !== this.findRowIndex(e.getRelatedTarget())) {
...
Ext.grid.EditorGridPanel = Ext.extend(Ext.grid.GridPanel, {
    ...
    preEditValue: function (r, field) {
        return this.autoEncode && typeof value == 'string' ? Ext.util.Format
            .htmlDecode(r.data[field]) : r.data[field];
    },
    ...
    onRender: function (ct, position) {
        ...
        if (this.textEl) {
            ...
            this.textEl = new Ext.CompositeElement([
                this.textTopEl.dom.firstChild, textBackEl.dom.firstChild]);
        ...
        if (!this.waitTimer) {
            ...
            this.waitTimer = Ext.TaskMgr.start({
                run: function (i) {
                    ...
                    this
                        .updateProgress(((((i + inc) % inc) + 1) * (100 / inc))
                            * .01);
                },
