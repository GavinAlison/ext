...
Ext.extend(Ext.ux.DateTime, Ext.form.Field, {
	...
	/**//**
		 * @cfg {Number} timeWidth Width of time field in pixels (defaults to
		 *      100)
		 */
	,
	timeWidth : 100
	/**//**
		 * @cfg {String} dtSeparator Date - Time separator. Used to split date
		 *      and time (defaults to ' ' (space))
		 */
	,
	dtSeparator : ' '
	/**//**
	...
	/**//**
		 * @cfg {Boolean} otherToNow Set other field to now() if not explicly
		 *      filled in (defaults to true)
		 */
	,
	otherToNow : true
	/**//**
		 * @cfg {Boolean} emptyToNow Set field value to now if on attempt to set
		 *      empty value. If it is true then setValue() sets value of field
		 *      to current date and time (defaults to false) /**
		 * @cfg {String} timePosition Where the time field should be rendered.
		 *      'right' is suitable for forms and 'bellow' is suitable if the
		 *      field is used as the grid editor (defaults to 'right')
		 */
	,
	...
	dateFormat : 'm/d/y'
	/**//**
		 * @cfg {String} timeFormat Format of TimeField. Can be localized.
		 *      (defaults to 'g:i A')
		 */
	,
	timeFormat : 'g:i A'
...
// fire events later
	...
	/**//**
		 ...
		 *         methods of DateField and TimeField
		 */
	,
	validate : function() {
	...
	renderer : function(field) {
		...
		var format = field.editor.dateFormat
				|| Ext.ux.DateTime.prototype.dateFormat;
		format += ' '
				+ (field.editor.timeFormat || Ext.ux.DateTime.prototype.timeFormat);
